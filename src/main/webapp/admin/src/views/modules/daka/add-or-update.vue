    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="打卡" prop="dakaName">
                       <el-input v-model="ruleForm.dakaName"
                                 placeholder="打卡" clearable  :readonly="ro.dakaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="打卡" prop="dakaName">
                           <el-input v-model="ruleForm.dakaName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.dakaFile" label="照片" prop="dakaFile">
                        <file-upload
                                tip="点击上传照片"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.dakaFile" label="照片" prop="dakaFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.dakaFile"  >照片下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
