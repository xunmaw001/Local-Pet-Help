...
public class JiayangLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiayangLiuyanEntity() {

	}

	public JiayangLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "jiayang_liuyan_text")

    private String jiayangLiuyanText;
	 ...
	 * 获取：留言内容
	 */
    public String getJiayangLiuyanText() {
        return jiayangLiuyanText;
    }
    /**
	 * 设置：留言内容
	 */

    public void setJiayangLiuyanText(String jiayangLiuyanText) {
        this.jiayangLiuyanText = jiayangLiuyanText;
    }
    /**
	 * 获取：留言时间
	 */
    ...
    public String toString() {
        return "JiayangLiuyan{" +
            ", id=" + id +
            ", jiayangId=" + jiayangId +
            ", yonghuId=" + yonghuId +
            ", jiayangLiuyanText=" + jiayangLiuyanText +
