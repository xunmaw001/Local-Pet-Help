...
*/
@TableName("jiayang")
public class JiayangView extends JiayangEntity implements Serializable {
	...
	*/
	...
	public JiayangView(JiayangEntity jiayangEntity) {
		try {
			BeanUtils.copyProperties(this, jiayangEntity);
