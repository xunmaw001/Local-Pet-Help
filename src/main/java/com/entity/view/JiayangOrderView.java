...
public class JiayangOrderView extends JiayangOrderEntity implements Serializable {
	...
	*/
	...
	private String jiayangOrderValue;
	...
	public JiayangOrderView() {

	}

	public JiayangOrderView(JiayangOrderEntity jiayangOrderEntity) {
		try {
			BeanUtils.copyProperties(this, jiayangOrderEntity);
	...
	* 获取： 领养类型的值
	*/
	public String getJiayangOrderValue() {
		return jiayangOrderValue;
	}
	/**
	* 设置： 领养类型的值
	*/
	public void setJiayangOrderValue(String jiayangOrderValue) {
		this.jiayangOrderValue = jiayangOrderValue;
	}
	...
	public String toString() {
		return "JiayangOrderView{" +
			", jiayangOrderValue=" + jiayangOrderValue +
