...
*/
@TableName("xuanshang")
public class XuanshangView extends XuanshangEntity implements Serializable {
	...
	*/
	...
	public XuanshangView() {

	}

	public XuanshangView(XuanshangEntity xuanshangEntity) {
		try {
			BeanUtils.copyProperties(this, xuanshangEntity);
